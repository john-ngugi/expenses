...
SECRET_KEY = 'django-insecure-9b#6dv)qx^#h&y)^%&+dymg4d4!@-h!w77a@z2#7smzs@a%c!-'
...
template_Directory_path = os.path.join(BASE_DIR, 'templates')
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [template_Directory_path],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
